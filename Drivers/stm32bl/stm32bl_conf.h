...
#ifndef __stm32bl_conf_H
#define __stm32bl_conf_H
...
/* uncomment lines below to use start delay in bootloader */
#define STM32BL_ENABLE_START_DELAY		

#define STM32BL_START_TIMER_DELAY					1500  /* ms */
...
#define STM32BL_FLASH_USER_START_ADDR   				ADDR_FLASH_PAGE_16   /* Start @ of user Flash area */
#define STM32BL_FLASH_USER_START_ADDR_OFFSET 		0
#define STM32BL_FLASH_USER_END_ADDR     				ADDR_FLASH_PAGE_127    /* End @ of user Flash area */

#define STM32BL_BUFF_SIZE									256
#define STM32BL_WORD_SIZE									4									/*32bit reg = 1 word*/
#define STM32BL_FLASH_PAGE_SIZE						FLASH_PAGE_SIZE 	/* 1KByte */

#define STM32BL_FLASH_CRC_ADDR 						((uint32_t) STM32BL_FLASH_USER_START_ADDR + \
																											STM32BL_FLASH_USER_START_ADDR_OFFSET - \
																											STM32BL_FLASH_PAGE_SIZE * 1)//addr of FlashCRC
																					
#define STM32BL_FLASH_CRC_VAL							((uint32_t)0x11223344)

#define STM32BL_FLASH_SETTINGS_ADDR 			((uint32_t) STM32BL_FLASH_USER_START_ADDR + \
																											STM32BL_FLASH_USER_START_ADDR_OFFSET - \
																											STM32BL_FLASH_PAGE_SIZE * 2)//addr of FlashCRC
/* Backups Registers */
#define STM32BL_BACKUP_MAIN_REG								RTC_BKP_DR1 /* use first backup reg of CPU */
#define STM32BL_BACKUP_BL_TIMEOUT_REG					RTC_BKP_DR2 /* use second backup reg of CPU */

#define STM32BL_BACKUP_REG_VAL_DEF						0x00 
#define STM32BL_BACKUP_REG_VAL								0x55 
